...
},{"base64-js":26,"ieee754":29,"isarray":28}],28:[function(require,module,exports){
    ...
    return (
      React.createElement("div", {className: "col-md-3 col-sm-6 hero-feature text-center"}, 
        React.createElement("div", {className: "thumbnail"}, 
          React.createElement("img", {src: "" + this.props.brewery.label, width: "150", alt: ""}), 
          React.createElement("div", {className: "caption"}, 
            React.createElement("h3", null, this.props.brewery.name), 
            React.createElement("p", null, 
              "Brewery_Type: ", this.props.brewery.brewery_type, " ", React.createElement("br", null), 
              "Address: ", this.props.brewery.address, " ", React.createElement("br", null), 
              "Founded: ", year, " ", React.createElement("br", null)
            ), 
            React.createElement("p", null, 
              React.createElement("a", {href: "/breweries/" + this.props.brewery.id + "/", className: "btn btn-primary"}, "More Info")
            )
          )
        )
      )
...
class ProductTable extends React.Component {
  render() {
    ...
    sortedProducts.forEach((brewery) => {
      rows.push(
        React.createElement(Brewery, {brewery: brewery})
      );
    });
    ...
    return (
      React.createElement("div", {className: "col-md-3"}, 
        React.createElement("div", {className: "list-group"}, 
          React.createElement("div", {className: "dropdown"}, 
            React.createElement("button", {className: " list-group-item btn btn-default dropdown-toggle", type: "button", "data-toggle": "dropdown"}, "Sort By", 
              ...
              React.createElement("ul", {className: "dropdown-menu", onClick: this.handleSortByChange}, 
                ...
                React.createElement("li", null, React.createElement("a", {href: "#", id: "brewery_type"}, "Brewery Type"))
              )
          ), 
          ...
          React.createElement("div", {className: "dropdown"}, 
            React.createElement("button", {className: " list-group-item btn btn-default dropdown-toggle", type: "button", "data-toggle": "dropdown"}, "Brewery Type", 
              React.createElement("span", {className: "caret"})), 
              React.createElement("ul", {className: "dropdown-menu", onClick: this.handleTypeChange}, 
                React.createElement("li", {className: "boxes"}, React.createElement("input", {id: "micro brewery", type: "checkbox"}), " Micro Brewery ", React.createElement("br", null)), 
                React.createElement("li", {className: "boxes"}, React.createElement("input", {id: "restaurant", type: "checkbox"}), " Restaurant ", React.createElement("br", null)), 
                React.createElement("li", {className: "boxes"}, React.createElement("input", {id: "bar", type: "checkbox"}), " Bar ", React.createElement("br", null))
              )
          )
...
ReactDOM.render(React.createElement(FilterableProductTable, null),document.getElementById('breweries'));

},{"axios":1,"lodash":30}]},{},[32]);
