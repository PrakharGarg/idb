      ...
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "dropdown"}, 
          React.createElement("button", {className: " list-group-item btn btn-default dropdown-toggle", type: "button", "data-toggle": "dropdown"}, "Type", 
            React.createElement("span", {className: "caret"})), 
            React.createElement("ul", {className: "dropdown-menu"}, 
              React.createElement("li", {class: "boxes"}, React.createElement("input", {type: "checkbox"}), " Stout ", React.createElement("br", null)), 
              React.createElement("li", {class: "boxes"}, React.createElement("input", {type: "checkbox"}), " IPA ", React.createElement("br", null)), 
              React.createElement("li", {class: "boxes"}, React.createElement("input", {type: "checkbox"}), " Sour ", React.createElement("br", null))
            )
        ), 
        ...
        React.createElement("div", {className: "dropdown"}, 
          React.createElement("button", {className: " list-group-item btn btn-default dropdown-toggle", type: "button", "data-toggle": "dropdown"}, "Rating", 
            React.createElement("span", {className: "caret"})), 
            React.createElement("ul", {className: "dropdown-menu"}, 
              React.createElement("li", {class: "boxes"}, React.createElement("input", {type: "checkbox"}), " 2+ ", React.createElement("br", null)), 
              React.createElement("li", {class: "boxes"}, React.createElement("input", {type: "checkbox"}), " 3+ ", React.createElement("br", null)), 
              React.createElement("li", {class: "boxes"}, React.createElement("input", {type: "checkbox"}), " 4+")
            )
        )
