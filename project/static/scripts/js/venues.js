...
class ProductTable extends React.Component {
  render() {
    ...
    sortedProducts.forEach((venue) => {
      rows.push(
        React.createElement(Venue, {venue: venue})
      );
    });
    ...
    return (
      React.createElement("div", {className: "col-md-3"}, 
        React.createElement("div", {className: "list-group"}, 
          React.createElement("div", {className: "dropdown"}, 
            React.createElement("button", {className: " list-group-item btn btn-default dropdown-toggle", type: "button", "data-toggle": "dropdown"}, "Sort By", 
              ...
              React.createElement("ul", {className: "dropdown-menu", onClick: this.handleSortByChange}, 
                ...
                React.createElement("li", null, React.createElement("a", {href: "#", id: "category"}, "Category"))
              )
          ), 
          ...
          React.createElement("div", {className: "dropdown"}, 
            React.createElement("button", {className: " list-group-item btn btn-default dropdown-toggle", type: "button", "data-toggle": "dropdown"}, "Category", 
              React.createElement("span", {className: "caret"})), 
              React.createElement("ul", {className: "dropdown-menu", onClick: this.handleTypeChange}, 
                ...
                React.createElement("li", {className: "boxes"}, React.createElement("input", {id: "brewery", type: "checkbox"}), " Brewery ", React.createElement("br", null))
              )
          )
...
ReactDOM.render(React.createElement(FilterableProductTable, null),document.getElementById('venues'));
