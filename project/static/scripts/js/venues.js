            ...
            return (
              React.createElement("div", {className: "col-md-3 col-sm-6 hero-feature text-center"}, 
                    ...
                    venue.address
									...
									React.createElement("p", null, 
										React.createElement("a", {href: "/venues/" + venue.id + "/", className: "btn btn-primary"}, "More Info")
									)
								)
							)
						)
...
ReactDOM.render(React.createElement(App, null),document.getElementById('venues'));
