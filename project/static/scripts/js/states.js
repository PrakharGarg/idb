    ...
    return (
      React.createElement("div", {className: "col-md-3 col-sm-6 hero-feature text-center"}, 
        React.createElement("div", {className: "thumbnail"}, 
          React.createElement("img", {src: "" + this.props.state.media, width: "150", alt: ""}), 
          React.createElement("div", {className: "caption"}, 
            React.createElement("h3", null, this.props.state.name), 
            React.createElement("p", null, 
              "Capital: ", this.props.state.capital, " ", React.createElement("br", null), 
              "Abbreviation: ", this.props.state.abbreviation, " ", React.createElement("br", null), 
              "State Flower: ", this.props.state.flower, " ", React.createElement("br", null)
            ), 
            React.createElement("p", null, 
              React.createElement("a", {href: "/states/" + this.props.state.id + "/", className: "btn btn-primary"}, "More Info")
            )
          )
        )
      )
...
class ProductTable extends React.Component {
  render() {
    ...
    sortedProducts.forEach((state) => {
      rows.push(
        React.createElement(State, {state: state})
      );
    });
...
ReactDOM.render(React.createElement(FilterableProductTable, null),document.getElementById('states'));
